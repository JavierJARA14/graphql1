...
async function runApiTests() {
  console.log('>>> Test 1: Executing getAllUsers...');
  await fetchGraphQL(GET_ALL_USERS_QUERY);
  
  console.log('\n=============================================\n');

  console.log('>>> Test 2: Executing getUserById (requesting id: "1")...');
  // Pasa la variable { id: "1" }
  await fetchGraphQL(GET_USER_BY_ID_QUERY, { id: "1" });

  console.log('\n=============================================\n');

  console.log('>>> Test 3: Executing createUser...');
  // Define las variables para el nuevo usuario
  const newUserVars = {
    name: "Carlos Sanchez",
  ...
  console.log('>>> Test 4: Executing getAllUsers');
  await fetchGraphQL(GET_ALL_USERS_QUERY);
  console.log('\nAll tests finished.');
}
